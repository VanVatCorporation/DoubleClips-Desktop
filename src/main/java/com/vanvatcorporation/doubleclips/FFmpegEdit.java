...
public class FFmpegEdit {
    ...
    public static void runAnyCommand(String cmd, String taskName,
                                     ...
                                     java.util.function.Consumer<String> onLogRunnable, java.util.function.Consumer<FFmpegEditNative.FfmpegStatistics> onStatisticsRunnable) {
        FFmpegEditNative.runAnyCommand(cmd, taskName, "Ran command!", "Command failed: ", true, onSuccessRunnable, onFailRunnable, onLogRunnable, onStatisticsRunnable);
    }
    ...
    public static void runAnyCommand(String cmd, String taskName, String successMessage, String failMessage, boolean includeFullReport) {
        FFmpegEditNative.runAnyCommand(cmd, taskName, successMessage, failMessage, includeFullReport, () -> {}, () -> {}, s -> {}, stats -> {});
    }
...
//                        .append("))")
    ...
    public static float getTimeInTimebase(String timebase, VideoProperties.ValueType type, Keyframe keyframe, Clip clip)
    {
        if (Objects.equals(timebase, "T")) {
            if (type == VideoProperties.ValueType.Speed) {
...
//        }
    ...
    public static class FfmpegRenderQueue {
        ...
        public static class FfmpegRenderQueueInfo {
            ...
            Consumer<FFmpegEditNative.FfmpegStatistics> onStatistics = stats -> {};
